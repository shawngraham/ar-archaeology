...
...and this is 'hacking' because Twine is meant to make choose-your-own-adventure type games; it was never envisioned to use it with geolocation. What we'll do then is hack the ability to trigger passages of text through physical proximity to a particular location (a 'geotrigger'). If you haven't played any Twine-type games, try ['Beneath Floes'](http://www.bravemule.com/beneathfloes) first. (Here's a great review on [Killscreen](http://killscreendaily.com/articles/escape-icy-clutches-inuit-legend-beneath-floes/). (Speaking of which, and as it happens, another game (built in Unity3d) based on Inuit culture was reviewed in [Internet Archaeology](http://intarch.ac.uk/journal/issue38/6/reinhard.html) recently.)  [Profhacker](http://chronicle.com/blogs/profhacker/tag/twine) has written about the pedagogical potentials of Twine several times. 
